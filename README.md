...
- 对照：**应用说明 → 能力与待办**；宽睿对接：**宽睿对接 → 宽睿文档梳理**（M0✓ → M1～M4 可选✓ → M5a/M5b/撤单小修/仿真浸泡/查询增强✓；具名约 20/24；**下一步** **M6 银证** → L2/两融后置）
...
- 宽睿 **计划**（剩余 · 2026-08-08）：⑥ **M6 银证** `sendCashTrsfReq`+流水查询（真仓）；批量 `sendBatchOrdsReq`（按需）；⑦ 后置 L2/UDP/两融/期权/ETF。详见「宽睿文档梳理」
