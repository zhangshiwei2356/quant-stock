...
public class DocsPdfService {
    ...
    static {
        ...
        list.add(new Topic("memo", "app", "待办清单", "memo.html"));
        ...
        list.add(new Topic("ma", "stock", "均线与金叉", "ma.html"));
        list.add(new Topic("volume", "stock", "成交量与放量", "volume.html"));
        list.add(new Topic("rsi", "stock", "RSI", "rsi.html"));
        list.add(new Topic("atr", "stock", "ATR", "atr.html"));
        list.add(new Topic("adx", "stock", "ADX", "adx.html"));
        list.add(new Topic("boll", "stock", "布林带", "boll.html"));
